...
#define FREQ_STEP_DOWN                          (55000)
#define FREQ_SLEEP_MAX                          (192000)
#define FREQ_AWAKE_MIN                          (810000)
...
unsigned int cpu_freq_sampling_latency_multiplier = 1000;
unsigned int cpu_freq_min_ticks = 10;
