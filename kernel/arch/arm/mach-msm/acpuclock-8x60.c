...
static struct clkctl_acpu_speed acpu_freq_tbl_slowest[] = {
  ...
  { {1, 1}, 1674000,  ACPU_SCPLL, 0, 0, 1, 0x1F, L2(19), 1305000, 0x03006000},
//ganesh
...
//ganesh
  { {1, 1}, 1728000,  ACPU_SCPLL, 0, 0, 1, 0x20, L2(19), 1250000, 0x03006000},
  ...
  { {1, 1}, 1914000,  ACPU_SCPLL, 0, 0, 1, 0x24, L2(22), 1275000, 0x03006000},
  { {1, 1}, 1998000,  ACPU_SCPLL, 0, 0, 1, 0x25, L2(22), 1275000, 0x03006000},
  { {1, 1}, 2052000,  ACPU_SCPLL, 0, 0, 1, 0x26, L2(22), 1300000, 0x03006000},
  { {0, 0}, 0 },
};
...
//ganesh
  { {1, 1}, 1728000,  ACPU_SCPLL, 0, 0, 1, 0x20, L2(19), 1200000, 0x03006000},
  { {1, 1}, 1782000,  ACPU_SCPLL, 0, 0, 1, 0x21, L2(22), 1200000, 0x03006000},
  { {1, 1}, 1836000,  ACPU_SCPLL, 0, 0, 1, 0x22, L2(22), 1200000, 0x03006000},
  { {1, 1}, 1890000,  ACPU_SCPLL, 0, 0, 1, 0x23, L2(22), 1225000, 0x03006000},
  { {1, 1}, 1914000,  ACPU_SCPLL, 0, 0, 1, 0x24, L2(22), 1225000, 0x03006000},
  { {1, 1}, 1998000,  ACPU_SCPLL, 0, 0, 1, 0x25, L2(22), 1225000, 0x03006000},
  { {1, 1}, 2052000,  ACPU_SCPLL, 0, 0, 1, 0x26, L2(22), 1250000, 0x03006000},
  { {0, 0}, 0 },
};
...
//ganesh
  { {1, 1}, 1728000,  ACPU_SCPLL, 0, 0, 1, 0x20, L2(19), 1150000, 0x03006000},
  { {1, 1}, 1782000,  ACPU_SCPLL, 0, 0, 1, 0x21, L2(22), 1150000, 0x03006000},
  { {1, 1}, 1836000,  ACPU_SCPLL, 0, 0, 1, 0x22, L2(22), 1150000, 0x03006000},
  { {1, 1}, 1890000,  ACPU_SCPLL, 0, 0, 1, 0x23, L2(22), 1175000, 0x03006000},
  { {1, 1}, 1914000,  ACPU_SCPLL, 0, 0, 1, 0x24, L2(22), 1175000, 0x03006000},
  { {1, 1}, 1998000,  ACPU_SCPLL, 0, 0, 1, 0x25, L2(22), 1175000, 0x03006000},
  { {1, 1}, 2052000,  ACPU_SCPLL, 0, 0, 1, 0x26, L2(22), 1200000, 0x03006000},
  { {0, 0}, 0 },
};
...
static __init struct clkctl_acpu_speed *select_freq_plan(void)
{
	...
	if (speed_bin == 0x2) {
//ganesh
		max_khz = 1728000; // 1998000;  //1674000;
		switch (pvs) {
		case 0x7:
		case 0x5:
...
//ganesh
		max_khz = 1728000; //1998000; //1674000 1512000;
		switch (pvs) {
		case 0x0:
		case 0x7:
			acpu_freq_tbl = acpu_freq_tbl_slow;
...
static int __init acpuclk_8x60_init(struct acpuclk_soc_data *soc_data)
{
	...
	for_each_online_cpu(cpu)
		//acpuclk_8x60_set_rate(cpu, max_freq->acpuclk_khz, SETRATE_INIT); Ganesh
